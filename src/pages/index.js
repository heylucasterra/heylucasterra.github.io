...
<article>
  ...
  <h4 style={{color:`var(--font-mid-contrast)`}}>My first real job as a designer was at a tiny company in the heart of São Paulo focused on what we then called "new media" — or social media if you prefer. I would help companies find ways to take advantage of existing media to connect with customers, from video projections in the city to thinking about an app they could have in their profiles that would get customers engaged. Ah, around that time business pages on Facebook were in the very beginning and it kind of served as a catalyst to the work I was already doing. </h4>
  <h4 style={{color:`var(--font-mid-contrast)`}}></h4>
  <h4 style={{color:`var(--font-mid-contrast)`}}></h4>
  </article>
