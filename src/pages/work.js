...
const IndexPage = () => (
  ...
  <Layout>
    ...
    {/* <motion.article initial={{opacity: 0,}} animate={{x: 0, y: -24, scale: 1, rotate: 0, opacity: 1,}} transition={{duration: 0.5,  ease: "easeOut", delay: 0.25,}} style={{}}>
      <h1>I help teams make thoughtful product decisions. Sometimes I also help them stop bad design from happening.</h1>
    </motion.article>

<hr style={{maxWidth:1080}}></hr>
<br></br>
<br></br> */}
...
<motion.article initial={{opacity: 0,}} animate={{x: 0, y: -24, scale: 1, rotate: 0, opacity: 1,}} transition={{duration: 0.5,  ease: "easeOut", delay: 0.35,}} style={{}}>
  ...
  <h4 style={{color:`var(--font-mid-contrast)`}}>In 2019, Nu was the <a href="https://qz.com/1738245/nubanks-app-has-more-downloads-than-revolut-monzo-and-n26-combined/
" target="blank">most downloaded</a> banking app in the world and in 2020 we have launched our credit card in <a href="https://techcrunch.com/2020/03/03/valued-at-10b-nubank-launches-its-nu-credit-card-in-mexico/" target="blank">Mexico</a> and <a href="https://www.nasdaq.com/articles/brazilian-financial-startup-nubank-expands-to-colombia-2020-09-30" target="blank">Colombia</a>.</h4>
 ...
 <div initial={{opacity: 0,}} animate={{x: 0, y: -24, scale: 1, rotate: 0, opacity: 1,}} transition={{duration: 0.5,  ease: "easeOut", delay: 0.45,}} style={{}} style={{maxWidth:`100%`,justifyContent:`center`,textAlign:`center`}}> 
  <div style={{opacity:`100%`,display:`flex`,overflow:`scroll`,textAlign:`left`,height:`32rem`,justifyContent:`flex-start`, marginBottom:`1.45rem`}}>
      ...
      <Link to="/nubank/credit-card-design" class="thumbnail-wrapper" style={{height:504, width:255, marginLeft:8}}>
...
<article>
  ...
  <h4 style={{color:`var(--font-mid-contrast)`}}>At Livework I have worked on a number of service and product design projects, mostly spamming accross mobility, health and finance combining physical and digital experiences.</h4>
