...
(function(exports) {
  ...
  var prettyPrintValue = function (v) {
      ...
      throw new Error("Failed pattern match at Neodoc.Value line 194, column 1 - line 194, column 37: " + [ v.constructor.name ]);
  };
      ...
      return function (split) {
          ...
          var number = Control_Bind.bind(Neodoc_Parsing_Parser.bindParser)(Neodoc_Parsing_Parser_Combinators.option(1)(Control_Apply.applySecond(Neodoc_Parsing_Parser.applyParser)(Neodoc_Parsing_Parser_String["char"]("-"))(Control_Applicative.pure(Neodoc_Parsing_Parser.applicativeParser)(-1 | 0))))(function (v) {
              return Control_Bind.bind(Neodoc_Parsing_Parser.bindParser)(Data_Functor.map(Neodoc_Parsing_Parser.functorParser)(Data_Foldable.foldMap(Data_List_Types.foldableList)(Data_Monoid.monoidString)(Data_String.singleton))(Neodoc_Parsing_Parser_Combinators.some(Neodoc_Parsing_Parser_String.digit)))(function (v1) {
                  return Neodoc_Parsing_Parser_Combinators.choice(Data_Foldable.foldableArray)([ Data_Functor.map(Neodoc_Parsing_Parser.functorParser)(function ($209) {
                      return FloatValue.create((function (v2) {
                          return Data_Int.toNumber(v) * v2;
                      })(Global.readFloat($209)));
                  ...
                  })), Control_Applicative.pure(Neodoc_Parsing_Parser.applicativeParser)(IntValue.create(v * Data_Maybe.fromJust()(Data_Int.fromString(v1)) | 0)) ]);
              });
          });
          var bool = (function () {
              var true$prime = Control_Bind.bind(Neodoc_Parsing_Parser.bindParser)(Neodoc_Parsing_Parser_Combinators.choice(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(function ($210) {
                  return Neodoc_Parsing_Parser_Combinators["try"](Neodoc_Parsing_Parser_String.string($210));
              })([ "true", "True", "TRUE" ])))(function () {
                  return Control_Applicative.pure(Neodoc_Parsing_Parser.applicativeParser)(new BoolValue(true));
              });
              var false$prime = Control_Bind.bind(Neodoc_Parsing_Parser.bindParser)(Neodoc_Parsing_Parser_Combinators.choice(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(function ($211) {
          ...
          var p = (function () {
              ...
              throw new Error("Failed pattern match at Neodoc.Value line 224, column 11 - line 224, column 51: " + [ split.constructor.name ]);
          })();
  ...
  var asForeignValue = new Data_Foreign_Class.AsForeign(function (v) {
      ...
      throw new Error("Failed pattern match at Neodoc.Value line 77, column 3 - line 77, column 41: " + [ v.constructor.name ]);
  });
              ...
              var go = function (v) {
                  return function (v1) {
                      if (v instanceof Neodoc_ArgParser_Token.SOpt && (v.value0 === f && (!isFlag && Data_Array["null"](v.value1)))) {
                          ...
                          throw new Error("Failed pattern match at Neodoc.ArgParser.Argument line 239, column 17 - line 245, column 80: " + [ $33.constructor.name ]);
                      };
                      if (v instanceof Neodoc_ArgParser_Token.SOpt && (v.value0 === f && (!isFlag && !Data_Array["null"](v.value1)))) {
                      ...
                      if (v instanceof Neodoc_ArgParser_Token.SOpt && (v.value0 === f && (isFlag && Data_Array["null"](v.value1)))) {
                          ...
                          throw new Error("Failed pattern match at Neodoc.ArgParser.Argument line 276, column 7 - line 282, column 26: " + [ v.value2.constructor.name ]);
                      };
              ...
              return Control_Bind.bind(Neodoc_Parsing_Parser.bindParser)(Neodoc_Parsing_Parser.getInput)(function (v) {
                  if (v instanceof Data_List_Types.Cons) {
                      ...
                      return Control_Bind.bind(Neodoc_Parsing_Parser.bindParser)(go(v.value0.value0)(nextToken))(function (v1) {
                          ...
                          if ($51) {
                              var va = Data_Maybe.maybe([  ])(function ($108) {
                                  return Data_Array.singleton(Neodoc_Value.StringValue.create($108));
                              })(v1.rawValue);
                          ...
                          if (!$51) {
                              ...
                              var rest$prime = (function () {
                                  ...
                                  throw new Error("Failed pattern match at Neodoc.ArgParser.Argument line 205, column 25 - line 208, column 36: " + [ $58.constructor.name ]);
                              })();
                          ...
                          throw new Error("Failed pattern match at Neodoc.ArgParser.Argument line 178, column 9 - line 212, column 60: " + [ $51.constructor.name ]);
                      });
                  };
                  return Neodoc_Parsing_Parser.fail("Expected token, met EOF");
              });
          ...
          return function (mArg) {
              ...
              var go = function (v) {
                  return function (v1) {
                      ...
                      if (v instanceof Neodoc_ArgParser_Token.LOpt && (v.value1 instanceof Data_Maybe.Nothing && !isFlag)) {
                          var $88 = Data_String.stripPrefix(n)(v.value0);
                          if ($88 instanceof Data_Maybe.Just) {
                              return Control_Applicative.pure(Neodoc_Parsing_Parser.applicativeParser)({
                                  rawValue: new Data_Maybe.Just($88.value0), 
                                  hasConsumedArg: false, 
                                  explicitArg: false
                              });
                          };
                          return Neodoc_Parsing_Parser.fail("Invalid substring");
                      };
                      return Neodoc_Parsing_Parser.fail("Invalid token: " + Data_Pretty.pretty(Neodoc_ArgParser_Token.prettyToken)(v));
                  };
              };
                  ...
                  if (v instanceof Data_List_Types.Cons) {
                      ...
                      return Control_Bind.bind(Neodoc_Parsing_Parser.bindParser)(go(v.value0.value0)(nextToken))(function (v1) {
                          return Control_Bind.bind(Neodoc_Parsing_Parser.bindParser)(Neodoc_Parsing_Parser.setInput((function () {
                              ...
                              return Control_Applicative.pure(Neodoc_Parsing_Parser.applicativeParser)((function () {
                                  if (term) {
                                      var val = Neodoc_Value.ArrayValue.create(Data_Maybe.maybe([  ])(function ($109) {
                                          return Data_Array.singleton(Neodoc_Value.StringValue.create($109));
                                      })(v1.rawValue));
